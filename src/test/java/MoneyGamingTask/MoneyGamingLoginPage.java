...
public class MoneyGamingLoginPage {
    ...
    public void Task1() {
        ...
        WebElement termBox = driver.findElement(By.name("map(terms)"));
        termBox.click();
        ...
        //Validate that a validation with text "This field is required" appears under DOB
        String expectedError = "This field is required";
        String actualError = driver.findElement(By.xpath("//label[@for='dob'][\"This field is required\"]")).getText();

        Assert.assertEquals(actualError, expectedError, "verify DOB message");
